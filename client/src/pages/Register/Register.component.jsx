            ...
            <div className='register-content'>
                <div className='register-grid'>
                    <div className='caption fc-black-600'>
                        <h3>Join the Insti Overflow community</h3>
                        ...
                        <div className='caption-item'>
                            ...
                            <div className='grid--cell'>Unlock new privileges like answering and commenting</div>
                        </div>
                        <div className='caption-item'>
                            <div className='grid-icon'>
                                <svg width='26' height='26' className='svg-icon mtn2'>
                            ...
                            <div className='grid-cell'>Save your favorite tags, filters</div>
                        </div>
                        <div className='caption-item'>
